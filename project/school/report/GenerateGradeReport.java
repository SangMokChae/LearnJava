...
public class GenerateGradeReport {
	...
	public void makeBody(Subject subject) {
		...
		for(int i = 0; i < studentList.size(); i++) {
			...
			buffer.append(" | ");
			buffer.append(student.getSutdentId());
			buffer.append(" | ");
			buffer.append(student.getMajorSubject().getSubjectName() + "\t");
			buffer.append(" | ");
			
			getScoreGrade(student, subject.getSubjectId(), subject);
	...
	public void getScoreGrade(Student student, int subjectId, Subject subject) {
